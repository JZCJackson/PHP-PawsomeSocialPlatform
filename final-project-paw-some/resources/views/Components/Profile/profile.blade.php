                    ...
                    <div class="flex align-items-center justify-content-around mt-4">
                       @foreach($pets as $pet)
                            ...
                            <div class="pet_avatar">
                                <div class="pet_avatar_holder">
                                    <img src="/storage/pets/{{$pet->picture}}" alt="">
                                </div>
                        ...
                        <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                            ...
                            <div class="flex justify-between items-center lg:p-4 p-2.5">
                                <div class="flex flex-1 items-center space-x-4">
                                    @foreach($userdata as $user )
                                    <a href="#">
                                        <img src="/storage/profile/{{ $user->picture}}"
                                             class="bg-gray-200 border border-white rounded-full w-10 h-10 object-cover">
                                    </a>
                                    <div class="flex-1 font-semibold capitalize">
                                        <a href="#" class="text-black dark:text-gray-100"> {{$user->name}}</a>
                                        <div class="text-gray-700 flex items-center space-x-2">   {{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $post->created_at)->diffInHours(Carbon\Carbon::now()) }} Hrs </span>
...
{{--                                              class="rounded-full bg-gray-200 text-xl p-1 mr-3"></ion-icon>--}}
{{--                                    Followed By <strong> 30 People </strong>--}}
{{--                                </li>--}}
{{--                            </ul>--}}
...
{{--                    </div>--}}
                ...
                <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                    ...
                    <nav class="responsive-nav border-b">
                        <ul>
                            <li class="active"><a href="#" class="lg:px-2"> All Friends <span>  </span> </a></li>
                    ...
                    <div class="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-x-2 gap-y-4 mt-3">
                        ...
                        @foreach(\App\Models\User::all() as $user)
                            ...
                            <div class="pt-3 px-1">
                                <a href="timeline.html" class="text-base font-semibold mb-0.5"> {{$user->name}} </a>
                    ...
                    <div class="grid md:grid-cols-3 grid-cols-2  gap-x-2 gap-y-4 mt-3">
                        <div>
                            <a href="video-watch.html" class="w-full h-36 overflow-hidden rounded-lg relative block">
                                ...
                                <span
                                    class="absolute bg-black bg-opacity-60 bottom-1 font-semibold px-1.5 py-0.5 right-1 rounded text-white text-xs"> 12:21</span>
...
<div id="create-post-modal" class="create-post" uk-modal>
    ...
    {{--        </div>--}}
    {{--    </div>--}}
    <div class="uk-modal-dialog uk-modal-body rounded-xl shadow-2xl p-0 lg:w-3/12">
        ...
        <div class="border-b px-7 py-5">
            <div class="lg:text-2xl text-xl font-semibold mb-1"> Add a new pet</div>

        </div>
        <form class="p-7 space-y-5 " method="post" action="/pets" enctype="multipart/form-data">
        @csrf

            <input type="text" name="name" placeholder="Pet Name" class="with-border">
            <input type="text" placeholder="Dog/Cat" class="with-border" name="species">
            <input type="text" hidden name="author_id" value="{{$user->id}}" class="with-border">

{{--            <input type="file" name="picture" id="pet-image" hidden onchange="readURL(this);"/>--}}
{{--            <label for="pet-image" class="flex justify-content-between align-items-center cursor-pointer">--}}
{{--                <div class=" bottom-0 space-x-4 w-full">--}}
{{--                    <div class="flex bg-gray-50 border border-purple-100 rounded-2xl p-3 shadow-sm align-items-center justify-content-between">--}}
{{--                        <div class=""> Add Pet Image</div>--}}
{{--                        <div class="flex flex-1 items-end justify-content-end space-x-2">--}}
...
{{--            <img src="" alt=""  id="picture-preview" class="rounded-full overflow-hidden items-center relative w-1/3 h-1/3" />--}}
            <div class="self-center">
                <x-file-input title="Upload a picture of pet" />
            </div>

            <div class="flex">
                <input type="submit" name="submit" placeholder="Add a pet"
