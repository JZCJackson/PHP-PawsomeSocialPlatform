...
<div class="lg:flex max-w-5xl min-h-screen mx-auto p-6 py-10">
    <div class="flex flex-col items-center lg: lg:flex-row lg:space-x-10">
        ...
        <div class="lg:mb-12 flex-1 lg:text-left text-center">
            <img src="{{asset('assets/images/logo.png')}}" alt="" class="lg:mx-0 lg:w-52 mx-auto w-40">
            <p class="font-medium lg:mx-0 md:text-2xl mt-6 mx-auto sm:w-3/4 text-xl"> Connect with other Pet Owners in
                the world around you on Paw'some.</p>
        </div>
        <div class="lg:mt-0 lg:w-96 md:w-1/2 sm:w-2/3 mt-10 w-full flex justify-content-center align-items-center">
            ...
            {{--                <input type="email" placeholder="Email or Phone Number" class="with-border">--}}
            {{--                <input type="password" placeholder="Password" class="with-border">--}}
            {{--                <button type="button" class="bg-blue-600 font-semibold p-3 rounded-md text-center text-white w-full">--}}
            {{--                    Log In--}}
            {{--                </button>--}}
            ...
            @if (Route::has('login'))
                <div class=" fixed  m-4 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/feed') }}"
                           class="text-lg text-gray-700 dark:text-gray-500 p-4 border-blue-500 border-2 ">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}"
                           class="text-lg text-white rounded-md bg-blue-600 dark:text-gray-500 pt-2 pr-4 pl-4 pb-2 border-blue-500 border-2 hover:bg-blue-500 hover:text-white">Log
                            in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                               class="text-lg text-white rounded-md bg-blue-600 ml-2 dark:text-gray-500 pt-2 pr-4 pl-4 pb-2 border-blue-500 border-2 hover:bg-blue-500 hover:text-white">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
    ...
    <div class="uk-modal-dialog uk-modal-body rounded-xl shadow-2xl p-0 lg:w-5/12">
        ...
        <form class="p-7 space-y-5">
            <div class="grid lg:grid-cols-2 gap-5">
                ...
                <input type="text" placeholder="Last  Name" class="with-border">
            </div>
            <input type="email" placeholder="Info@example.com" class="with-border">
            <input type="password" placeholder="******" class="with-border">
            ...
            <div class="grid lg:grid-cols-2 gap-3">
                ...
                <div>
                    ...
                    <input type="text" placeholder="+543 5445 0543" class="with-border">
                </div>
            </div>
